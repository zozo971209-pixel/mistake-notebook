    ...
    <Card>
      ...
      <CardContent className="space-y-6 text-sm leading-7">
        <ol className="space-y-5">
          ...
          <GuideStep n="4" title="確認免費層與模型"><p>在 AI Studio 查看 Billing Tier 與 Rate Limits。免費額度依專案、地區與模型而異，不保證固定次數。本站預設使用 <code className="rounded bg-muted px-1.5 py-0.5">gemini-2.5-flash-lite</code>，官方價格頁目前仍列有免費輸入層。</p></GuideStep>
