...
export function QuestionBankAI({ questions, subjects }: { questions: LocalQuestion[]; subjects: LocalSubject[] }) {
  ...
  async function apply() {
    ...
    if (!assignments.length) return setMessage("沒有可套用的有效歸類，請先確認主題名稱。");
    setBusy(true); setMessage("");
    try {
