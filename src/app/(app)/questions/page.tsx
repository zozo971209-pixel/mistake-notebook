...
export default async function QuestionsPage({ searchParams }: { searchParams: Promise<{ q?: string; subject?: string; status?: string }> }) {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="題庫" description="快速找到需要重新理解的題目。" action={<Button asChild className="hidden sm:inline-flex"><Link href="/questions/new"><Plus />新增錯題</Link></Button>} />
